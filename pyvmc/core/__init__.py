...
from pyvmc.core.boundary_conditions import periodic, antiperiodic, periodic_bc, antiperiodic_bc, open_bc, boundary_condition_to_string, valid_boundary_conditions, valid_closed_boundary_conditions
